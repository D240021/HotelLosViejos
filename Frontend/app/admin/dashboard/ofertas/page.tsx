...
export default function GestionarOfertasPage() {
  ...
  function validateOffer(
    ...
    if (
      !offer.porcentaje ||
      isNaN(Number(offer.porcentaje)) ||
      Number(offer.porcentaje) <= 0 ||
      Number(offer.porcentaje) > 100
    )
  ...
  async function handleAddOffer() {
    ...
    try {
      ...
      setAlert({
        ...
        message: err.message || "No se pudo agregar la oferta.",
      });
    } finally {
      setIsSaving(false);
    }
  ...
  async function handleUpdateOffer(offerId: string) {
    ...
    if (isOfferActive(offerToUpdate)) {
      setAlert({
        type: "warning",
        title: "Oferta Activa",
        message: "No se puede modificar una oferta que está vigente.",
      });
      setIsSaving(false);
      return;
    }
    ...
    try {
      ...
      setAlert({
        ...
        message: err.message || "No se pudo actualizar la oferta.",
      });
    } finally {
      setIsSaving(false);
    }
  ...
  async function handleRemoveOffer(offerId: string) {
    ...
    if (isOfferActive(offerToRemove)) {
      setAlert({
        type: "warning",
        title: "Oferta Activa",
        message: "No se puede eliminar una oferta que está vigente.",
      });
      setIsSaving(false);
      return;
    }
    ...
    try {
      ...
      setAlert({
        ...
        message: err.message || "No se pudo eliminar la oferta.",
      });
    } finally {
      setIsSaving(false);
    }
  ...
  function handleSaveSeasonPercentages() {
    ...
    if (isNaN(alta) || alta < 0 || alta > 100) {
      setAlert({
        type: "error",
        title: "Error de Temporada",
        message: "El porcentaje de ALTA debe ser un número entre 0 y 100.",
      });
      return;
    }
    if (isNaN(baja) || baja < 0 || baja > 100) {
      setAlert({
        type: "error",
        title: "Error de Temporada",
        message: "El porcentaje de BAJA debe ser un número entre 0 y 100.",
      });
      return;
    }
    ...
    try {
      ...
      setAlert({
        type: "success",
        title: "Éxito",
        message: "Porcentajes de temporada guardados.",
      });
    } catch (e: any) {
      setAlert({
        type: "error",
        title: "Error de Temporada",
        message: "No se pudieron guardar los porcentajes.",
      });
    }
  }
          ...
          <div className="space-y-8">
            <div className="flex items-center gap-3 mb-2">
              ...
              <h1 className="text-2xl font-semibold text-gray-800">
                Gestionar Temporadas y Ofertas
              </h1>
            </div>
            ...
            <Card>
              ...
              <CardContent>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <Input
                        id="alta"
                        type="number"
                        value={altaPercentage}
                        onChange={(e) => setAltaPercentage(e.target.value)}
                        disabled={isSaving}
                      />
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <Input
                        id="baja"
                        type="number"
                        value={bajaPercentage}
                        onChange={(e) => setBajaPercentage(e.target.value)}
                        disabled={isSaving}
                      />
                      <span className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-500">
                        %
                ...
                <div className="flex justify-end mt-4">
                  <Button
                    onClick={handleSaveSeasonPercentages}
            ...
            <Card>
              ...
              <CardContent className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 p-4 bg-gray-50 rounded-lg">
                  ...
                  <Select
                    value={newOfferApplies}
                    onValueChange={setNewOfferApplies}
                    disabled={isSaving}
                  >
                    <SelectTrigger>
                        ...
                        >
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <DateSelector
                              ...
                              selectedDate={
                                new Date(
                                  editedOffers[offer.id]?.fechaInicio ||
                                    offer.fechaInicio
                                )
                              }
                              onDateChange={(date) =>
                            ...
                            <DateSelector
                              ...
                              selectedDate={
                                new Date(
                                  editedOffers[offer.id]?.fechaFin ||
                                    offer.fechaFin
                                )
                              }
                              minDate={
